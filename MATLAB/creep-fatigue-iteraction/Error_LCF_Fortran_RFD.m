function [res] = Error_LCF_Fortran_RFD(mater_param)
...
if(str==" computation too long" || str==" destruction" || str==" computation too long" || str==" destruction")
    ...
    res(4)=stress_amplitude_exp(4)-stress_amplitude_num(4);
end
...
if(str==" computation too long" || str==" destruction" || str==" computation too long" || str==" destruction")
    ...
    res(5)=stress_amplitude_exp(5)-stress_amplitude_num(5);
end
%res=10*res;
figure(3);
plot(strain_amplitude_exp,stress_amplitude_exp,'b', strain_amplitude_exp, stress_amplitude_num, 'r');
grid on;
